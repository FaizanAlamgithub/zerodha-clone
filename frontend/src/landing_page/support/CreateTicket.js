...
//           <h4 className="text-muted" style={{ fontWeight: "400" }}>
//             <i style={{ fontSize: "18px" }} class="fa-solid fa-plus"></i>{" "}
//             Account Opening
//           </h4>
//           <div className="col px-4 text-primary">
//             <p>Getting started</p>
//             <p>Online</p>
//             <p>Offline</p>
//             <p>Charges</p>
...
//         <div className="col-4 mt-5">
//           <h4 className="text-muted" style={{ fontWeight: "400" }}>
//             <i style={{ fontSize: "18px" }} class="fa-regular fa-user"></i> Your
//             Zerodha Account
//           </h4>
//           <div className="col px-4 text-primary">
...
//         <div className="col-4 mt-5">
//           <h4 className="text-muted" style={{ fontWeight: "400" }}>
//             <i style={{ fontSize: "18px" }} class="fa-solid fa-chart-line"></i>{" "}
//             Trading and Markets
//           </h4>
//           <div className="col px-4 text-primary">
//             <p>Trading FAQs</p>
...
//         <div className="col-4 mt-5">
//           <h4 className="text-muted" style={{ fontWeight: "400" }}>
//             <i style={{ fontSize: "18px" }} class="fa-solid fa-wallet"></i>{" "}
//             Funds
//           </h4>
//           <div className="col px-4 text-primary">
//             <p>Fund withdrawal</p>
...
//         <div className="col-4 mt-5">
//           <h4 className="text-muted" style={{ fontWeight: "400" }}>
//             <i style={{ fontSize: "18px" }} class="fa-regular fa-copyright"></i>{" "}
//             Your Console
//           </h4>
//           <div className="col px-4 text-primary">
//             <p>IPO</p>
...
//         <div className="col-4 mt-5">
//           <h4 className="text-muted" style={{ fontWeight: "400" }}>
//             <i style={{ fontSize: "18px" }} class="fa-solid fa-coins"></i> Coin
//           </h4>
//           <div className="col px-4 text-primary">
...
import React from "react";
import "./CreateTicket.css"; // Optional external CSS for additional styling
